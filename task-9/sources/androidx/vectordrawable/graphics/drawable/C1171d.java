...
import p024d0.C1730a;
import p024d0.C1731b;
import p024d0.C1732c;

/* renamed from: androidx.vectordrawable.graphics.drawable.d */
public class C1171d {
    /* renamed from: a */
    private static Interpolator m5800a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) {
        Interpolator gVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            gVar = new C1175g(context, asAttributeSet, xmlPullParser);
                        } else {
    ...
    /* renamed from: b */
    public static Interpolator m5801b(Context context, int i) {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m5800a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
